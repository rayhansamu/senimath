...
function PagePanduan({ navigateTo, themeClasses }) {
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <h2 className="text-3xl font-bold text-center">Panduan Penggunaan</h2>
      ...
      <div className="space-y-6">
        <h3 className="text-2xl font-bold border-b pb-2 text-center">5 Tipe Latihan Soal</h3>
        ...
        {[
          ...
          <div key={idx} className={`p-6 md:p-8 rounded-3xl ${themeClasses.cardBg} border border-l-8 border-l-blue-500 shadow-sm`}>
            ...
            <p className="mb-6 opacity-90 text-lg leading-relaxed text-justify" dangerouslySetInnerHTML={{ __html: item.desc }}></p>
      ...
      <div className={`mt-12 p-8 rounded-3xl bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 border border-blue-300 dark:border-blue-700 text-center shadow-sm`}>
        ...
        <p className="text-indigo-800 dark:text-indigo-200 mb-6 text-lg text-justify">Buat lo yang masih merasa kurang latihan soal, lo bisa kunjungi toko dan membeli paket 100 latihan soal dan jawaban pada materi yang sedang lo pelajari.</p>
        <button
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch pt-4">
          ...
          <div className={`p-6 rounded-3xl ${themeClasses.cardBg} border border-slate-200 dark:border-slate-700 border-t-4 border-t-slate-300 dark:border-t-slate-700 shadow-md hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 flex flex-col relative overflow-hidden`}>
            ...
            <div className="mb-6 mt-2">
              ...
              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1">Pendampingan Langsung, Fokus Penuh Tanoa Distraksi</p>
            </div>
            <ul className="space-y-4 mb-8 flex-1 text-slate-700 dark:text-slate-200">
              <li className="flex items-center gap-3 text-sm sm:text-base font-medium">
